...
class WebApiTests(unittest.TestCase):
    ...
    def test_options_health_and_index_routes(self):
        ...
        self.assertIn('id="report-tab-current"', index.text)
        self.assertIn('id="report-tab-compiled"', index.text)
        ...
        self.assertIn('class="results-reader"', index.text)
        ...
        self.assertIn("setActiveReportTab", script.text)
        ...
        self.assertIn(".results-reader", stylesheet.text)
        self.assertIn(".report-tabs", stylesheet.text)
    ...
    def test_run_creation_snapshot_retrieval_events_and_export(self):
        ...
        self.assertTrue((report_path.parent / "reports" / "market_report.md").exists())
        self.assertTrue((report_path.parent / "message_tool.log").exists())
        self.assertIn(
            "log line",
            (report_path.parent / "message_tool.log").read_text(encoding="utf-8"),
        )
