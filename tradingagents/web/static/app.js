...
function captureElements() {
  ...
  elements.reportTabCurrent = document.getElementById("report-tab-current");
  elements.reportTabCompiled = document.getElementById("report-tab-compiled");
  elements.reportPanelCurrent = document.getElementById("report-panel-current");
  elements.reportPanelCompiled = document.getElementById("report-panel-compiled");
...
function bindEvents() {
  ...
  elements.reportTabCurrent.addEventListener("click", () => setActiveReportTab("current"));
  elements.reportTabCompiled.addEventListener("click", () => setActiveReportTab("compiled"));
}
...
function renderReportTabs() {
  const currentActive = state.activeReportTab === "current";
  elements.reportTabCurrent.classList.toggle("is-active", currentActive);
  elements.reportTabCompiled.classList.toggle("is-active", !currentActive);
  elements.reportTabCurrent.setAttribute("aria-selected", String(currentActive));
  elements.reportTabCompiled.setAttribute("aria-selected", String(!currentActive));
  elements.reportPanelCurrent.classList.toggle("hidden", !currentActive);
  elements.reportPanelCompiled.classList.toggle("hidden", currentActive);
}
